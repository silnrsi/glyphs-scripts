...
tell application "Finder"
	...
	tell application "Terminal"
		...
		tell window 1
	        	...
	        	do script "which python3; python3 --version; python3 -m pip --version; sudo python3 -m pip uninstall --yes pysilfont glyphsLib fontTools mutatorMath ufoLib defcon fontMath; sudo python3 -m pip install --upgrade --no-cache-dir git+https://github.com/silnrsi/pysilfont.git@master#egg=pysilfont git+https://github.com/googlei18n/GlyphsLib.git@v3.1.4#egg=glyphsLib fontTools fs mutatorMath ufoLib defcon fontMath ; psfversion"
